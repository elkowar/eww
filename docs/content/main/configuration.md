...
For specific built in widgets `<box>, <text>, <slider>, etc` see [Widget Documetation](https://todo)
...
In here you whole widget will be made, and you can also create your own widgets. Check [Widget Documentation](asd) for pre-defined widgets.
